...
const I18N = {
  en: {
    ...
    includeLatest: "Include Latest models",
    includeLatestDescription: "Show models labeled Latest in their name or ID.",
  ...
  "zh-CN": {
    ...
    includeLatest: "包含 Latest 模型",
    includeLatestDescription: "显示名称或 Model ID 标记为 Latest 的模型。",
    search: "搜索模型",
